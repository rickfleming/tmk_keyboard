static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     *
     * ,--------------------------------------------------.           ,--------------------------------------------------.
     * |  TRNS  |  F1  |  F2  |  F3  |  F4  |  F5  | F6   |           |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |  {L3}  |
     * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
...
static const uint16_t PROGMEM fn_actions[] = {
	...
	ACTION_DEFAULT_LAYER_SET(0),						// FN0 - default layer 0 (qwerty)
	ACTION_DEFAULT_LAYER_SET(1),						// FN1 - default layer 1 (workman)
	ACTION_DEFAULT_LAYER_SET(2),						// FN2 - default layer 2 (workman programmer)

	ACTION_LAYER_TAP_KEY(3, KC_FN4),				// FN3 - momentary layer 3 (fn-keys)
	ACTION_LAYER_TOGGLE(3),							// FN4 - invert layer 3 (fn-keys)
